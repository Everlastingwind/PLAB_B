        ...
        {heroAvatarGridOpen ? (
          <div
            className={cn(
              ...
              "md:grid-flow-col md:grid-rows-3 md:grid-cols-none md:auto-cols-[minmax(44px,1fr)] md:gap-x-1.5 md:gap-y-1.5 md:overflow-x-auto md:overflow-y-hidden md:pb-0.5"
            )}
          >
            {attrHeroes.map((h) => (
              <button
